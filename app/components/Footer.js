  ...
  return (
    <footer className='relative max-container padding-container py-36 flex xs:gap-12 lg:gap-20 xs:flex-col lg:flex-row'>
      ...
      <div className='flex flex-col gap-12 lg:w-1/3'>
        ...
        <div className='flex flex-col gap-4'>
          <div className='logo flex items-center gap-2'>
            <Image src='/hoparound_logo.svg' alt='logo' width={40} height={40} />
            <h2 className='font-bold text-2xl'>HopAround</h2>
          </div>
      ...
      <div className='right lg:w-2/3 flex xs:flex-col md:flex-row xs:gap-10 md:gap-0 md:justify-between'>
        ...
        <FooterCard title='Contact' link1='Why HopAround?' link2='Partner with us' link3='FAQ’s' link4='Blog' />
        <FooterCard title='Meet Us' link1='+00 92 1234 56789' link2='info@hoparound.com' link3='205. R Street, New York BD23200' />
      </div>
    </footer>
  )
}
